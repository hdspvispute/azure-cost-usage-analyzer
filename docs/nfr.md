...
| All Azure API calls must exist only in app/azure and not in UI or service layers. | Search for Azure SDK client usage/imports outside app/azure and fail review if found. |
